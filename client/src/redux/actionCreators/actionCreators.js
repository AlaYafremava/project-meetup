import { INIT_USER, INIT_TAGS,CHECK_TAG, LOGOUT, INIT_PEOPLE, ADD_FRIEND, REMOVE_FRIEND,JOIN, UNJOIN , INIT_VISIBLES_MARKS, CHANGE_VISIBILITY_USER } from '../actionTypes/actionTypes'
